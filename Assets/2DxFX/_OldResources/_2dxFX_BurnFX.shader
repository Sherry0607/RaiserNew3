...
float4 c = smoothstep(t/1.0, t+.1, a(3.5*uv));
float ca2 = smoothstep(t / 2.5, t + .5, a(3.5*uv));
c=tex*c;
c.r=lerp(c.r - _Distortion, c.r*10.0*(1-c.a)*24,_Distortion);
c.g=lerp(c.g - _Distortion, c.g*10.0*(1-c.a)   ,_Distortion);
c.b=lerp(c.b - _Distortion, c.b*10.0*(1-c.a)   ,_Distortion);
