...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Desintegration);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_DesintegrationFX)),CanEditMultipleObjects]
public class _2dxFX_AL_DesintegrationFX_Editor : Editor
{
...
_2dxFX_AL_DesintegrationFX _2dxScript = (_2dxFX_AL_DesintegrationFX)target;
