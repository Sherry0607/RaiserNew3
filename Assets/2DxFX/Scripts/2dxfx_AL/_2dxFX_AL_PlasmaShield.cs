...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_PlasmaShield)),CanEditMultipleObjects]
public class _2dxFX_AL_PlasmaShield_Editor : Editor
{
...
_2dxFX_AL_PlasmaShield _2dxScript = (_2dxFX_AL_PlasmaShield)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("_ColorX"), new GUIContent("Change the colors", icone, "Change the plasma colors"));
