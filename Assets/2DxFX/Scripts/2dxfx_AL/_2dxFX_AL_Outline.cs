...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_OutLineSpread", _OutLineSpread);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_Outline)),CanEditMultipleObjects]
public class _2dxFX_AL_Outline_Editor : Editor
{
...
_2dxFX_AL_Outline _2dxScript = (_2dxFX_AL_Outline)target;
