...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_HSV)),CanEditMultipleObjects]
public class _2dxFX_AL_HSV_Editor : Editor
{
...
_2dxFX_AL_HSV _2dxScript = (_2dxFX_AL_HSV)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("_HueShift"), new GUIContent("Hue Shift", icone, "Change hue colors"));
