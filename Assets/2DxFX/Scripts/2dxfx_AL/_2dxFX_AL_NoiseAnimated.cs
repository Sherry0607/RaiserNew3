...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Noise);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_NoiseAnimated)),CanEditMultipleObjects]
public class _2dxFX_AL_NoiseAnimated_Editor : Editor
{
...
_2dxFX_AL_NoiseAnimated _2dxScript = (_2dxFX_AL_NoiseAnimated)target;
