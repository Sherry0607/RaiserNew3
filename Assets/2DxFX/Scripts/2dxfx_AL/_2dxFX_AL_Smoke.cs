...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Value2", _TurnToSmoke);
...
public class _2dxFX_AL_Smoke_Editor : Editor
{
...
_2dxFX_AL_Smoke _2dxScript = (_2dxFX_AL_Smoke)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("_TurnToSmoke"), new GUIContent("Turn To Smoke", icone, "Turn To Smoke Value"));
