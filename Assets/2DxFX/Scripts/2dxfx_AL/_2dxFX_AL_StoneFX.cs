...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", IntoStone);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_StoneFX)),CanEditMultipleObjects]
public class _2dxFX_AL_StoneFX_Editor : Editor
{
...
_2dxFX_AL_StoneFX _2dxScript = (_2dxFX_AL_StoneFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("IntoStone"), new GUIContent("Into Stone", icone, "Turn into Stone"));
