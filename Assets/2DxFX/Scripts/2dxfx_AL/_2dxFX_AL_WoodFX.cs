...
[HideInInspector] [Range(0, 1)] public float IntoWood = 1.0f;
...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", IntoWood);
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Deep", Deep);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_WoodFX)),CanEditMultipleObjects]
public class _2dxFX_AL_WoodFX_Editor : Editor
{
...
_2dxFX_AL_WoodFX _2dxScript = (_2dxFX_AL_WoodFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("IntoWood"), new GUIContent("Into wood", icone, "Turn into wood"));
icone = Resources.Load ("2dxfx-icon-value") as Texture2D;
EditorGUILayout.PropertyField(m_object.FindProperty("Deep"), new GUIContent("Fracture", icone, "Change the fracture of the stone"));
