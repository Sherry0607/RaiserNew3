...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Posterize);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_Posterize)),CanEditMultipleObjects]
public class _2dxFX_AL_Posterize_Editor : Editor
{
...
_2dxFX_AL_Posterize _2dxScript = (_2dxFX_AL_Posterize)target;
