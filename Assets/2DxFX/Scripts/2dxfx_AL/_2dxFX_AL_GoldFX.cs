...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Gold);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_GoldFX)),CanEditMultipleObjects]
public class _2dxFX_AL_GoldFX_Editor : Editor
{
...
_2dxFX_AL_GoldFX _2dxScript = (_2dxFX_AL_GoldFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("Gold"), new GUIContent("Gold Value", icone, "Turn your sprite into a golden sprite !"));
