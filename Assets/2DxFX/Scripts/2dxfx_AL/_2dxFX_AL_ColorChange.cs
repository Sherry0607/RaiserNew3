...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Tolerance", _Tolerance);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_ColorChange)),CanEditMultipleObjects]
public class _2dxFX_AL_ColorChange_Editor : Editor
{
...
_2dxFX_AL_ColorChange _2dxScript = (_2dxFX_AL_ColorChange)target;
