...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Metal);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_MetalFX)),CanEditMultipleObjects]
public class _2dxFX_AL_MetalFX_Editor : Editor
{
...
_2dxFX_AL_MetalFX _2dxScript = (_2dxFX_AL_MetalFX)target;
