...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_LightningBolt)),CanEditMultipleObjects]
public class _2dxFX_AL_LightningBolt_Editor : Editor
{
...
_2dxFX_AL_LightningBolt _2dxScript = (_2dxFX_AL_LightningBolt)target;
