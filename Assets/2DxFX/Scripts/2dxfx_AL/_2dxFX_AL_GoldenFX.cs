...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_GoldenFX)),CanEditMultipleObjects]
public class _2dxFX_AL_GoldenFX_Editor : Editor
{
...
_2dxFX_AL_GoldenFX _2dxScript = (_2dxFX_AL_GoldenFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("Golden"), new GUIContent("Gold Value", icone, "Turn your sprite into a golden sprite !"));
