...
this.GetComponent<Renderer>().material.SetFloat("_OffsetX",_AutoScrollCountX);
this.GetComponent<Renderer>().material.SetFloat("_OffsetY",_OffsetY);
}
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_Pattern)),CanEditMultipleObjects]
public class _2dxFX_AL_Pattern_Editor : Editor
{
...
_2dxFX_AL_Pattern _2dxScript = (_2dxFX_AL_Pattern)target;
