...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_RandomPos", RandomPos);
...
public class _2dxFX_AL_JellyAutoMove_Editor : Editor
{
...
_2dxFX_AL_JellyAutoMove _2dxScript = (_2dxFX_AL_JellyAutoMove)target;
