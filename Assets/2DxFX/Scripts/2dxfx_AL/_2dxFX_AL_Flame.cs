...
void Update()
{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Speed", _Speed);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_Flame)),CanEditMultipleObjects]
public class _2dxFX_AL_Flame_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_AL_Flame _2dxScript = (_2dxFX_AL_Flame)target;
