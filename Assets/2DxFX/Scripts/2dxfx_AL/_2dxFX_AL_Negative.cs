...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Negative);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_Negative)),CanEditMultipleObjects]
public class _2dxFX_AL_Negative_Editor : Editor
{
...
_2dxFX_AL_Negative _2dxScript = (_2dxFX_AL_Negative)target;
