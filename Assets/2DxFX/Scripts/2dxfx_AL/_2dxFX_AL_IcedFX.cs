...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_IcedFX)),CanEditMultipleObjects]
public class _2dxFX_AL_IcedFX_Editor : Editor
{
...
_2dxFX_AL_IcedFX _2dxScript = (_2dxFX_AL_IcedFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("Iced"), new GUIContent("Iced Value", icone, "Turn your sprite into an iced sprite !"));
