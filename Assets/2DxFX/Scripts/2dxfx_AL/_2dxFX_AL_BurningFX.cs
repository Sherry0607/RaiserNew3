...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Colors);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
CanvasImage.material.SetFloat("_Alpha", 1-_Alpha);
CanvasImage.material.SetFloat("_Distortion", Colors);
}
}
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_BurningFX)),CanEditMultipleObjects]
public class _2dxFX_AL_BurningFX_Editor : Editor
{
...
_2dxFX_AL_BurningFX _2dxScript = (_2dxFX_AL_BurningFX)target;
...
EditorGUILayout.PropertyField(m_object.FindProperty("Colors"), new GUIContent("Color", icone, "Change the color of the sprite"));
