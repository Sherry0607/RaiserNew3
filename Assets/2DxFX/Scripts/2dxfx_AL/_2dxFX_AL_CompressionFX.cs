...
this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Parasite);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_CompressionFX)),CanEditMultipleObjects]
public class _2dxFX_AL_CompressionFX_Editor : Editor
{
...
_2dxFX_AL_CompressionFX _2dxScript = (_2dxFX_AL_CompressionFX)target;
