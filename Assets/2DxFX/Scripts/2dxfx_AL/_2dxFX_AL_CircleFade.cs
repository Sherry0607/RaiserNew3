...
this.GetComponent<Renderer>().sharedMaterial.SetInt("_InOut", _InOut);
}
else if(this.gameObject.GetComponent<Image>() != null)
{
CanvasImage.material.SetFloat("_Alpha", 1-_Alpha);
CanvasImage.material.SetFloat("_Offset", _Offset);
CanvasImage.material.SetInt("_InOut", _InOut);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_AL_CircleFade)),CanEditMultipleObjects]
public class _2dxFX_AL_CircleFade_Editor : Editor
{
...
_2dxFX_AL_CircleFade _2dxScript = (_2dxFX_AL_CircleFade)target;
