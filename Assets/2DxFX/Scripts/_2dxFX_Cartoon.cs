...
public class _2dxFX_Cartoon : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_ColorLevel", _ColorLevel);
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_EdgeSize", _EdgeSize);
			}
			else if(this.gameObject.GetComponent<Image>() != null)
			{
				CanvasImage.material.SetFloat("_Alpha", 1-_Alpha);
				CanvasImage.material.SetFloat("_ColorLevel", _ColorLevel);
				CanvasImage.material.SetFloat("_EdgeSize", _EdgeSize);
			}
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_Cartoon)),CanEditMultipleObjects]
public class _2dxFX_Cartoon_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_Cartoon _2dxScript = (_2dxFX_Cartoon)target;
		...
		if (_2dxScript.ActiveChange)
		{
			...
			EditorGUILayout.PropertyField(m_object.FindProperty("_ColorLevel"), new GUIContent("Color Level", icone, "Change the level color of the sprite"));
			icone = Resources.Load ("2dxfx-icon-edge") as Texture2D;
			EditorGUILayout.PropertyField(m_object.FindProperty("_EdgeSize"), new GUIContent("Edge Size", icone, "Change the size of the black lines"));
