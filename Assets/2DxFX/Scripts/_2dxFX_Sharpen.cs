...
public class _2dxFX_Sharpen : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Sharpen);
			}
			else if(this.gameObject.GetComponent<Image>() != null)
			{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_Sharpen)),CanEditMultipleObjects]
public class _2dxFX_Sharpen_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_Sharpen _2dxScript = (_2dxFX_Sharpen)target;
