...
public class _2dxFX_SandFX : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Sand);
			}
			else if(this.gameObject.GetComponent<Image>() != null)
			{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_SandFX)),CanEditMultipleObjects]
public class _2dxFX_SandFX_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_SandFX _2dxScript = (_2dxFX_SandFX)target;
