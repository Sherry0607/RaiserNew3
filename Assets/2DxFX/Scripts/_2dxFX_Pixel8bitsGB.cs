...
public class _2dxFX_Pixel8bitsGB : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Offset2", _Offset);
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_Pixel8bitsGB)),CanEditMultipleObjects]
public class _2dxFX_Pixel8bitsGB_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_Pixel8bitsGB _2dxScript = (_2dxFX_Pixel8bitsGB)target;
		...
		if (_2dxScript.ActiveChange)
		{
			...
			EditorGUILayout.PropertyField(m_object.FindProperty("_Offset"), new GUIContent("Brightness Color", icone, "Change the brightness of the color"));
			EditorGUILayout.BeginVertical("Box");
