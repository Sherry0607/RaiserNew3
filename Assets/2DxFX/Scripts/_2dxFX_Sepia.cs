...
public class _2dxFX_Sepia : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", _EffectAmount);
			}
			else if(this.gameObject.GetComponent<Image>() != null)
			{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_Sepia)),CanEditMultipleObjects]
public class _2dxFX_Sepia_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_Sepia _2dxScript = (_2dxFX_Sepia)target;
		...
		if (_2dxScript.ActiveChange)
		{
			...
			EditorGUILayout.PropertyField(m_object.FindProperty("_EffectAmount"), new GUIContent("Turn into Sepia", icone, "Turn into Sepia"));
