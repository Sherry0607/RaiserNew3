...
public class _2dxFX_Teleportation : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (ActiveChange)
		{
			...
			this.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", Teleportation);
			}
			else if(this.gameObject.GetComponent<Image>() != null)
			{
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_Teleportation)),CanEditMultipleObjects]
public class _2dxFX_Teleportation_Editor : Editor
{
